 ...
 * 如果不压缩，即返回原路径
 */
fun Activity.compressMedias(pickerOption: SeveralPickerOption, mediaList: MutableList<MediaEntity>, loading: Dialog, onResult: (ArrayList<String>) -> Unit) {
    val result: ArrayList<String> = ArrayList()
    if (!pickerOption.isCompress) {
        mediaList.forEach {
