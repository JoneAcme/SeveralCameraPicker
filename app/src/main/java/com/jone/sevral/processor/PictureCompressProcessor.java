...
import com.jone.sevral.processor.internal.PictureCompressor;
import com.jone.sevral.processor.listener.OnCompressListener;
...
public final class PictureCompressProcessor implements Processor {
    ...
    @Override
    public MediaEntity syncProcess(Context context, MediaEntity mediaEntity, PickerOption phoenixOption) {
    ...
    @Override
    public void asyncProcess(Context context, final MediaEntity mediaEntity, PickerOption phoenixOption, final OnProcessorListener onProcessorListener) {
